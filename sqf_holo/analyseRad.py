...
def mainLoop(fileline):
  ...
  if fileline != 13:
    ...
    plt.savefig("SQF-throughput-th-exp-holo.pdf",bbox_inches="tight",pad_inches=0.01);
    plt.savefig("SQF-throughput-th-exp-holo.png",bbox_inches="tight",pad_inches=0.01);
  plt.clf();
