...
int main(int argc, char **argv)
{
   if (argc < 6)
   {
      ...
      cerr << "Use: " << endl;
      cerr << "createScenario <file> <numRobots> <prob> <log> <dist> [video]" << endl;
      cerr << "command issued: '";
   ...
   double TARGET_SIZE = atof(argv[5]);
   ...
   for(int i = 0; i < numRobots; i++)
   {
      ...
      output << "robot" << endl
             ...
             << "  ctrl \"coordination.so " << i << " " << numRobots << " " << PROB_ANGER << " " << argv[1] << " " << argv[4] << " " << TARGET_SIZE << "\"" << endl
             << ")" << endl << endl;
